...
@Autonomous(name = "One Red", group = "autonomous")
public class OneRed extends LiveAutoBase {
    ...
    public void on_start() {
        ...
        robot.drive_train.odo_move(1,-24,0,0.5);
        robot.lift.elevate_to(3);
        robot.drive_train.odo_move(63.5,-24,0,0.5);
        robot.drive_train.odo_move(63.5,-17,0,0.3);
        sleep(200);
        robot.lift.elevate_to(0);
        robot.lift.open_claw();
        sleep(600);
        robot.drive_train.odo_move(63.5,-24,0,0.5);
        robot.drive_train.odo_move(51.5,-24,0,0.5);
