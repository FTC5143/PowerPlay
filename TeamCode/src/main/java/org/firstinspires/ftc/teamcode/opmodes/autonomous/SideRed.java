...
public class SideRed extends LiveAutoBase {
    ...
    public void on_start() {
        ...
        robot.drive_train.odo_move(49.5,-11,1.57,0.4,1,0.05);
        ...
        robot.drive_train.odo_move(49.5,-11,1.57,0.5,1,0.05);
        robot.drive_train.odo_move(51.5,24,0,0.5,1,0.05);
        robot.drive_train.odo_move(51.5,29,0,0.3,1,0.05,2);
        sleep(600);
        robot.lift.close_claw();
        sleep(400);
        ...
        robot.drive_train.odo_move(50.5,-11,1.57,0.4,1,0.05);
        ...
        robot.drive_train.odo_move(50.5,-11,1.57,0.5,1,0.05);
        robot.drive_train.odo_move(52.5,24,0,0.5,1,0.05);
        robot.drive_train.odo_move(52.5,29,0,0.3,1,0.05,2);
        sleep(600);
        robot.lift.close_claw();
        sleep(400);
        ...
        robot.drive_train.odo_move(53.5,24,0,0.,1,0.05);
        robot.drive_train.odo_move(53.5,29,0,0.3,1,0.05,2);
        sleep(600);
        robot.lift.close_claw();
        sleep(400);
        ...
        if (pattern == 1) {
            robot.drive_train.odo_move(53.5,18,1.57,1);
        }
        else if (pattern == 2) {
            robot.drive_train.odo_move(53.5,0,1.57,1);
        }
        else if (pattern == 3) {
            robot.drive_train.odo_move(53.5,-18,1.57,1);
        }
